...
?>
<header><center><h1>Login</h1></center></header><br><br>

<center><h2>Please fill in your details below.</h2></center>
        <br>
        ...
        <br>
        <p style="float: right">Don't have an account? <a href="register.php">Sign up now</a>.</p>
<?php
